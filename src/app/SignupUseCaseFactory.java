...
public class SignupUseCaseFactory {
    ...
    public static SignupView create(
        ...
        try {
            ...
            ClearUserDataAccessInterface clearDataAccessObject = new FileUserDataAccessObject("./users.csv", new CommonUserFactory());
            ClearInteractor clearInteractor = new ClearInteractor(clearDataAccessObject, clearOutputBoundary);
